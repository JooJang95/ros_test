#include "ros/ros.h"
#include "service_tutorial/AddTwoInts.h"   // service 헤더 파일 
                                            // 빌드시 자동 생성
...
int main(int argc,char** argv){
    ...
    // 서비스 이름은 (add_two_ints)이고, 요청이 왔을때 콜백함수 (add)을 실행한다.
    // (service_tutorial) 패키지의 (AddTwoInts)서비스 파일을 이용한다. <콜백함수 안에 정의 되어있다.>
